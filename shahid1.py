#!/usr/bin/python3
#-*-coding:utf-8-*-
# Made With ❤️ By Shahid And XNSCODE Project
# Update V6.2
...
# Facebook (Shahid Hussain)   : Facebook.com/shahid.baloch001
# Instagram (☬ 𝐀𝐧𝐨𝐧𝐲𝐦 𝟒𝟎𝟒 ☬)    : Instagram.com/ratya.anonym.id
# Whatsapp (Shahid)      : 03422001708
...
_logo_line_3_ = ('%s| |) | |\/| | _ \ _|  %s│   %s• Code By Shahid •   %s│'%(_P_,_U_,_P_,_U_))
